    ...
    <>
      <GiveWayContainer>
        <GiveWayContent>
          ...
          <GiveWayDescription>
            ...
            <p>
              Reveal a Avaxie with one of these BB1 (Avaxies 1ETH)
              companions and we will Airdrop you 1 ETH when Avaxie #19999 is
              minted.
      ...
      <CollectionContainer>
        ...
        <p>
          ...
          collection.
          <br /> Will you reveal one of these mega rare Avaxie NFTs?
        </p>
