...
const images: { [key: string]: any } = {
  capitalize1: {
    value: "./parts/color/1.png",
    key: "Color1",
    string: "Green",
    id: "1",
  },
  capitalize2: {
    value: "./parts/color/2.png",
    key: "Color2",
    string: "Gray",
    id: "2",
  },
  capitalize3: {
    value: "./parts/color/3.png",
    key: "Color3",
    string: "Pink",
    id: "3",
  },
  capitalize4: {
    value: "./parts/color/4.png",
    key: "Color4",
    string: "Purple",
    id: "4",
  },
  capitalize5: {
    value: "./parts/color/5.png",
    key: "Color5",
    string: "Red",
    id: "5",
  },
  capitalize6: {
    value: "./parts/color/6.png",
    key: "Color6",
    string: "Blue",
    id: "6",
  },
  capitalize7: {
    value: "./parts/color/7.png",
    key: "Color7",
    string: "Dark Blue",
    id: "7",
  },
  capitalize8: {
    value: "./parts/color/8.png",
    key: "Color8",
    string: "Orange",
    id: "8",
  },
  capitalize9: {
    value: "./parts/color/9.png",
    key: "Color9",
    string: "Yellow",
    id: "9",
  },
